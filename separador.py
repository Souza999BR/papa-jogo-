# 🔹 Lista bruta de links de cada cor (copie aqui suas listas completas)
links_vermelho = [
...
def limpar_lista(lista):
    limpa = []
    for link in lista:
        if link not in limpa:
            limpa.append(link)
    return limpa

IMAGENS_VERMELHO = limpar_lista(links_vermelho)
IMAGENS_AZUL = limpar_lista(links_azul)
IMAGENS_ALEATORIOS = limpar_lista(links_aleatorios)

# 🔹 Mostra o resultado limpo
print("✅ Vermelho:", len(IMAGENS_VERMELHO), "links")
for l in IMAGENS_VERMELHO:
    print(l)

print("\n✅ Azul:", len(IMAGENS_AZUL), "links")
for l in IMAGENS_AZUL:
    print(l)

print("\n✅ Aleatórios:", len(IMAGENS_ALEATORIOS), "links")
for l in IMAGENS_ALEATORIOS:
    print(l)